...
static Pixel_t __ApplyPixel_lightness(int x,int y,Pixel_t br_100,BufferInfo_t* pBufferInfo){
    ...
    Screen.buffer[M_SCREEN_MAIN][y][x].R = __limit((signed)(Screen.buffer[M_SCREEN_MAIN][y][x].R*br_100/100) , 0 , ((1<<8)-1));
    Screen.buffer[M_SCREEN_MAIN][y][x].G = __limit((signed)(Screen.buffer[M_SCREEN_MAIN][y][x].G*br_100/100) , 0 , ((1<<8)-1));
    Screen.buffer[M_SCREEN_MAIN][y][x].B = __limit((signed)(Screen.buffer[M_SCREEN_MAIN][y][x].B*br_100/100) , 0 , ((1<<8)-1));
    return 0;
}
